...
MODEL_PATH = AI_ROOT / "outputs" / "models" / "resnet18_best.pth"
OUTPUT_DIR = AI_ROOT / "outputs" / "resnet_embeddings"

def main():
    extractor = ResNetEmbeddingExtractor(MODEL_PATH, device="cpu")
